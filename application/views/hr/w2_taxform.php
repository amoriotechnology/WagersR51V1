      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page2-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:128px;left:63px;white-space:nowrap" class="ft23"><b>c &#160;</b>Employer’s name, address, and ZIP code <br><span style="color: #000; font-size: 14px;"><?php echo $c_details[0]['company_name'];echo "<br/>"; echo $getlocation[0]['address']; ?></span></p>
               <p style="position:absolute;top:236px;left:63px;white-space:nowrap" class="ft23"><b>d &#160;</b>Control number</p>
               <p style="position:absolute;top:272px;left:63px;white-space:nowrap" class="ft23"><b>e &#160;</b>Employee’s first name and initial <br><span style="color: #000; font-size: 14px;"><?php echo $gettaxdata[0]['first_name']." ".$gettaxdata[0]['middle_name']; ?></span></p>
               ...
               <p style="position:absolute;top:92px;left:508px;white-space:nowrap" class="ft23"><b>1 &#160;&#160;</b>Wages, tips, other compensation <br>
                  ...
                  <?php
if ($e_details[0]['choice'] == 'No' && !empty($get_payslip_info[0]['sales_c_amount'])) {
    $overalltotal_amount = number_format($get_payslip_info[0]['overalltotal_amount'] + $get_payslip_info[0]['sales_c_amount'], 2);
} else {
...
?>
               ...
               <p style="position:absolute;top:164px;left:508px;white-space:nowrap" class="ft23"><b>5 &#160;&#160;</b>Medicare wages and tips <br><span style="color: #000; font-size: 14px;font-size: 14px;">
...
if ($e_details[0]['choice'] == 'No' && !empty($get_payslip_info[0]['sales_c_amount'])) {
   $t_tax = 0;
   $t_tax = isset($get_payslip_info[0]['overalltotal_amount']) && isset($get_payslip_info[0]['sales_c_amount']) ? number_format($get_payslip_info[0]['overalltotal_amount'] + $get_payslip_info[0]['sales_c_amount'], 2) : '0.00';
              ...
              <?php
               ...
               <p style="position:absolute;top:344px;left:503px;white-space:nowrap" class="ft23"><b>14 &#160;</b>Other
                <br>
                  ...
                  <span>
                  <?php echo ($tax_info['tax'] ." ".$tax_info['code']); ?>  -  <?php echo number_format($tax_info['amount'], 3);?>    <br>
                  </span>  
                  <?php  endforeach; ?>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page3-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:128px;left:63px;white-space:nowrap" class="ft32"><b>c &#160;</b>Employer’s name, address, and ZIP code <br><span style="color: #000; font-size: 14px;"><?php echo $c_details[0]['company_name'];echo "<br/>"; echo $getlocation[0]['address']; ?></span></p>
...
?>  
               ...
               <p style="position:absolute;top:128px;left:508px;white-space:nowrap" class="ft32"><b>3 &#160;&#160;</b>Social security wages <br><span style="color: #000; font-size: 14px;">
...
if ($e_details[0]['choice'] == 'No' && !empty($get_payslip_info[0]['sales_c_amount'])) {
   $S_tax = 0; 
   $S_tax = isset($get_payslip_info[0]['overalltotal_amount']) && isset($get_payslip_info[0]['sales_c_amount']) ? number_format($get_payslip_info[0]['overalltotal_amount'] + $get_payslip_info[0]['sales_c_amount'], 2) : '0.00';
} else {
   $S_tax = 0; 
   $S_tax = isset($get_payslip_info[0]['overalltotal_amount']) ? number_format($get_payslip_info[0]['overalltotal_amount'], 2) : '0.00';
}
echo '$'.$S_tax;
?>
               ...
               <p style="position:absolute;top:164px;left:508px;white-space:nowrap" class="ft32"><b>5 &#160;&#160;</b>Medicare wages and tips <br><span style="color: #000; font-size: 14px;">
...
<?php echo !empty($matchedCode) ? htmlspecialchars($c_details[0]['State_Tax_ID_Number'], ENT_QUOTES, 'UTF-8') : ''; ?>
               ...
               <p style="position:absolute;top:434px;left:296px;white-space:nowrap" class="ft32"><b>16 &#160;</b>State wages, tips, etc 
                  ...
                  <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $t_tax,2, ENT_QUOTES, 'UTF-8') : ''; ?>
            
 
                  </span>
                  <span style="color: #000; font-size: 14px; position: relative; top: 30px;">
                  <?php echo !empty($matchedCode1) ? htmlspecialchars($currency .$t_tax,2, ENT_QUOTES, 'UTF-8') : ''; ?>  
                  </span> 
               </p>
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page4-div" style="position:relative;width:918px;height:1188px;    margin-left: 300px;">
               ...
               <p style="position:absolute;top:128px;left:63px;white-space:nowrap" class="ft41"><b>c &#160;</b>Employer’s name, address, and ZIP code <br><span style="color: #000; font-size: 14px;"><?php echo $c_details[0]['company_name'];echo "<br/>"; echo $getlocation[0]['address']; ?></span></p>
               ...
               <p style="position:absolute;top:92px;left:508px;white-space:nowrap" class="ft41"><b>1 &#160;&#160;</b>Wages, tips, other compensation 
                  ...
                  echo htmlspecialchars($formatted_tax, ENT_QUOTES, 'UTF-8');
                   ?> 
               ...
               <p style="position:absolute;top:128px;left:508px;white-space:nowrap" class="ft41"><b>3 &#160;&#160;</b>Social security wages <br><span style="color: #000; font-size: 14px;">
...
?>
               ...
               <p style="position:absolute;top:164px;left:508px;white-space:nowrap" class="ft41"><b>5 &#160;&#160;</b>Medicare wages and tips <br><span style="color: #000; font-size: 14px;">
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page6-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:128px;left:63px;white-space:nowrap" class="ft61"><b>c &#160;</b>Employer’s name, address, and ZIP code <br><span style="color: #000; font-size: 14px;"><?php echo $c_details[0]['company_name'];echo "<br/>"; echo $getlocation[0]['address']; ?></span></p>
               ...
               <p style="position:absolute;top:128px;left:508px;white-space:nowrap" class="ft61"><b>3 &#160;&#160;</b>Social security wages<br><span style="color: #000; font-size: 14px;">
...
?>
               ...
               <p style="position:absolute;top:164px;left:508px;white-space:nowrap" class="ft61"><b>5 &#160;&#160;</b>Medicare wages and tips<br><span style="color: #000; font-size: 14px;">
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page8-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:128px;left:63px;white-space:nowrap" class="ft81"><b>c &#160;</b>Employer’s name, address, and ZIP code <br><span style="color: #000; font-size: 14px;"><?php echo $c_details[0]['company_name'];echo "<br/>"; echo $getlocation[0]['address']; ?></span></p>
               ...
               <p style="position:absolute;top:128px;left:508px;white-space:nowrap" class="ft81"><b>3 &#160;&#160;</b>Social security wages<br><span style="color: #000; font-size: 14px;">
...
?>
               ...
               <p style="position:absolute;top:164px;left:508px;white-space:nowrap" class="ft81"><b>5 &#160;&#160;</b>Medicare wages and tips <br><span style="color: #000; font-size: 14px;">
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" lang="" xml:lang="">
         ...
         <body bgcolor="#A0A0A0" vlink="blue" link="blue">
            <div id="page10-div" style="position:relative;width:918px;height:1188px;     margin-left: 300px;">
               ...
               <p style="position:absolute;top:128px;left:63px;white-space:nowrap" class="ft102"><b>c &#160;</b>Employer’s name, address, and ZIP code <br><span style="color: #000; font-size: 14px;"><?php echo $c_details[0]['company_name'];echo "<br/>"; echo $getlocation[0]['address']; ?></span></p>
               ...
               <p style="position:absolute;top:128px;left:508px;white-space:nowrap" class="ft102"><b>3 &#160;&#160;</b>Social security wages <br><span style="color: #000; font-size: 14px;">
...
?>
               ...
               <p style="position:absolute;top:164px;left:508px;white-space:nowrap" class="ft102"><b>5 &#160;&#160;</b>Medicare wages and tips <br><span style="color: #000; font-size: 14px;">

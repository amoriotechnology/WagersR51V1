<div class="content-wrapper">
   <section class="content-header" style="height: 60px;">
      ...
      <div class="header-title">
         ...
         <h1><?php echo ('Medicare Tax'); ?></h1>
         </div>
            <ol class="breadcrumb" style=" border: 3px solid #d7d4d6;" >
               <li><a href="<?php echo base_url()?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
               <li><a href="#"><?php echo display('report') ?></a></li>
               <li class="active" style="color:orange"><?php echo 'Medicare Tax';?></li>
                     ...
                     <table class="table table-bordered" cellspacing="0" width="100%" id="socialsecuritytax_list">
                        <thead>
                            <tr  class="btnclr">
                                ...
                                <th colspan="2" class="4 value" data-col="4" style="text-align:center;width: 300px;"><?php echo ('Medicare Tax')?></th>
                            </tr>
                            <tr class="btnclr">
...
$(".sidebar-mini").addClass('sidebar-collapse') ;
    ...
    federalincomeDataTable = $('#socialsecuritytax_list').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('Chrm/medicaretaxIndexData?id='); ?>" +
